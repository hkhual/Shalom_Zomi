...
import imag2 from '../images/church_2.jpg'
import imag3 from '../images/church_4.JPG'
import imag4 from '../images/IMG_0015.JPG';
import imag5 from '../images/IMG_0017.JPG';
import imag6 from '../images/IMG_0100.JPG';
import imag7 from '../images/IMG_0085.JPG';
  ...
  return (
    <div className="slide-show">
      <AliceCarousel autoPlay autoPlayInterval="3000" mouseTrackingEnabled={true} infinite fadeOutAnimation={true}>
        ...
        <img src={imag7} alt="" className="slideImage" />
